        ...
        <script>
          ...
          function processPaginationChunk(runId) {
            ...
            if (currentOffset >= totalLen) {
              ...
              if (pendingTargetPage) {
                ...
                updateUI();
                pageSlider.style.width = estimatedTotalPages * pageStepWidth + "px";
              }
          ...
          function renderVirtualPages() {
            ...
            pageSlider.style.width =
              (isPaginating ? estimatedTotalPages : totalPages) * pageStepWidth +
              "px";
          }
          ...
          function setupEventListeners() {
            ...
            window.addEventListener(
              ...
              () => {
                ...
                resizeTimer = setTimeout(() => startPagination(currentPage), 250);
              },
              { passive: true },
            );
          }
